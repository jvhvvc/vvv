...
about:AddLabel("该脚本中心为测试版，永久免费，套的别人的")
about:AddLabel("自动更新")
about:AddParagraph("作者（不明）","希望这个")
about:AddLabel("作者QQ:2977114347 更新以及反馈QQ群:387466948")
about:AddLabel("可以捐款")
about:AddParagraph("这里声称")
about:AddParagraph("大型","平民玩家可以享受这大型的搞笑中心")
-----------------------------------------------------------------------------------------------------
...
Tab:AddButton({
	Name = "禁漫脚本中心",
	Callback = function()		loadstring(game:HttpGet("https://raw.githubusercontent.com/dingding123hhh/ng/main/jmlllllllIIIIlllllII.lua"))()
	end
})
    ...
    while task.wait(0.2) do
        if kspprop and KillTarget[1] then
            ...
            for _,pl in next, KillTarget do
                pcall(function()
                    local v = plrs[pl]
                    if v.Character and v.Character:FindFirstChild("HumanoidRootPart") and v ~= p
